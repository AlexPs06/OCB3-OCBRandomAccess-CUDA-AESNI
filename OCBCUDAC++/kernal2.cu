...
__global__ void OCB128EncryptRandomAccesAsociatedData(aesBlock *ad,aesBlock *delta, aesBlock *Ek1, aesBlock *result, unsigned long long adlen, unsigned long long deltalen, unsigned int *keys){
    int index = blockDim.x*blockIdx.x + threadIdx.x;
    if( index<adlen/16){
        // if( index==0){
...
extern "C++" void OCBRandomAccess(aesBlock *m,aesBlock *delta, aesBlock *S, const unsigned long long mlen, unsigned long long deltalen, unsigned int *keys){
    aesBlock *mCuda;
    aesBlock *SCuda;
    aesBlock *deltaCuda;
...
extern "C++" void OCBRandomAccessAsociatedData(aesBlock *ad, aesBlock *delta, aesBlock *Ek1, aesBlock *result, const unsigned long long adlen, unsigned long long deltalen, unsigned int *keys){
    aesBlock *adCuda;
    aesBlock *deltaCuda;
    aesBlock *Ek1Cuda;
    aesBlock *resultCuda;
    ...
    OCB128EncryptRandomAccesAsociatedData<<<nb, nt>>>(adCuda, deltaCuda, Ek1Cuda,resultCuda, adlen, deltalen,keysCuda);
    
    cudaMemcpy(result, resultCuda, sizeEk1, cudaMemcpyDefault);
...
extern "C++" void OCBRandomAccessDecrypt(aesBlock *m,aesBlock *delta,const unsigned long long mlen, unsigned long long deltalen, unsigned int *keys){
    aesBlock *mCuda;
    aesBlock *deltaCuda;
    unsigned int *keysCuda;
    ...
    OCB128DecryptRandomAcces<<<nb, nt>>>(mCuda,deltaCuda, mlen, deltalen,keysCuda);
    cudaMemcpy(m, mCuda, sizeMessage, cudaMemcpyDefault);
...
extern "C++" void AES128Encrypt(aesBlock *m, unsigned long long mlen, unsigned int *keys){
    aesBlock *mCuda;
    unsigned int *keysCuda;
    int sizeMessage = (mlen/16)*sizeof(class aesBlock);
    int sizeKeys = 11*4*sizeof(unsigned int);
