...
void mixColumns(unsigned char* in,  int * in1,  int * in2,  int * in3,  int * in4 ){
    ...
    for (int i = 0; i < 256; i++){
        ...
        //E * S⁻1[A]
        T1[0] =  multiplicacionENGF2(14, T1[0]);
        //9 * S⁻1[A]
        T1[1] =  multiplicacionENGF2( 9, T1[1]);
        //D * S⁻1[A]
        T1[2] =  multiplicacionENGF2(13, T1[2]);
        //B * S⁻1[A]
        T1[3] =  multiplicacionENGF2(11, T1[3]);

        //B * S⁻1[A]
        T2[0] =  multiplicacionENGF2(11, T2[0]);
        //E * S⁻1[A]
        T2[1] =  multiplicacionENGF2(14, T2[1]);
        //9 * S⁻1[A]
        T2[2] =  multiplicacionENGF2( 9, T2[2]);
        //D * S⁻1[A]
        T2[3] =  multiplicacionENGF2(13, T2[3]);

        //D * S⁻1[A]
        T3[0] =  multiplicacionENGF2(13, T3[0]);
        //B * S⁻1[A]
        T3[1] =  multiplicacionENGF2(11, T3[1]);
        //E * S⁻1[A]
        T3[2] =  multiplicacionENGF2(14, T3[2]);
        //9 * S⁻1[A]
        T3[3] =  multiplicacionENGF2( 9, T3[3]);

        //9 * S⁻1[A]
        T4[0] =  multiplicacionENGF2( 9, T4[0]);
        //D * S⁻1[A]
        T4[1] =  multiplicacionENGF2(13, T4[1]);
        //B * S⁻1[A]
        T4[2] =  multiplicacionENGF2(11, T4[2]);
        //E * S⁻1[A]
        T4[3] =  multiplicacionENGF2(14, T4[3]);
